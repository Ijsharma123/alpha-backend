...
/** Cover Photo File Path */
     ...
     router.route("/coverphoto/view/:_id").get(Token, CoverPhoto.CoverPhotoview)
...
/** Attachment File Path */
     ...
     router.route("/attachment/view/:_id").get(Token, Attachment.attachmentView)
     router.route("/attachment/edit/:_id").post(Token, attachUpload, Attachment.attachmentEdit)
...
/** SignOff Result File Path */
     ...
     router.route("/signoff/view/:_id").get(Token, SignOff.signView)
     router.route("/signoff/edit/:_id").post(Token, signUpload, SignOff.editSign)
     router.route("/signoff/delete/:_id").get(Token, SignOff.deleteSign)
